...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    private OnItemClickListener mOnOperItemClickL;
    private LayoutAnimationController mLac;

    public void setOnOperItemClickL(OnItemClickListener onOperItemClickL) {
        ...
        mLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mOnOperItemClickL != null) {
                    mOnOperItemClickL.onItemClick(parent, view, position, id);
                }
            }
        });
